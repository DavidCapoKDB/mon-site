...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirmPassword) {
        ...
        try {
            ...
            $fonction = 'vendeur';  // Définir la fonction comme client
            $stmtUser->bind_param("sss", $email, $hashedPassword, $fonction);
            $stmtUser->execute();
            $idUser = $conn->insert_id; // Obtenir l'ID du nouvel utilisateur
            
            // Insérer dans la table vendeurs
            $sqlClient = "INSERT INTO vendeurs (idVendeur, prenom, nom, adresse, telephone, email) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            $successMessage = "Compte vendeur créé avec succès !";
        } catch (Exception $e) {
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="text-center mt-3">
            <a href="accueilAdmin.php" class="btn-link">Retour</a>
        </div>
